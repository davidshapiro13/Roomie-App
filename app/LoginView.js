    ...
    return (
        <View style={styles.container}>
            ...
            <Modal animationType="slide"
                ...
                <CreateRoomView setLoggedIn={setLoggedIn} onClose={() => setCreateRoomOn(false)}></CreateRoomView>
            </Modal>
            ...
            <Modal animationType="slide"
                   ...
                   onRequestClose={() => {
                    ...
                    setJoinRoomOn(false);}}>
                <JoinRoomView setLoggedIn={setLoggedIn} onClose={() => setJoinRoomOn(false)}></JoinRoomView>
            </Modal>
